...
const AboutPage = () => {
    ...
    return (
        <div>
            ...
            <div data-aos="flip-left" data-aos-duration="1500" className={styles.box}>
                <div className={styles.custom}>
                    <div className={styles.item}>
                        <h3>Start your Journey</h3>
                        <p>
                            Participating in GSSoC’24 is an opportunity to upgrade your Github profile. Enrich
                            yourselves to learn, explore, improve, enhance, build connections and become a team player
                            to nourish your skills and personality. Don’t miss a chance to get well-versed with
                            Open-Source and essential tools like Git and Github under the supervision of excellent
                            mentors.
                        </p>
            ...
            <div data-aos="flip-right" data-aos-duration="1500" className="   mx-auto">
                <div className={styles.custom}>
                    <div className={styles.item}>
                        <h3>Start your Journey</h3>
                        <p>
